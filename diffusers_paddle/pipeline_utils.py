...
INDEX_FILE = "model_state.pdparams" # diffusion_paddle_model
...
class DiffusionPipeline(ConfigMixin):
    ...
    def register_modules(self, **kwargs):
        ...
        from diffusers_paddle import pipelines
    ...
    def to(self, paddle_device: Optional[Union[str, str]] = None):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        for name, (library_name, class_name) in init_dict.items():
            ...
            if isinstance(loaded_sub_model, nn.Layer):
                if loaded_sub_model.dtype != paddle_dtype:
    ...
    @staticmethod
    def numpy_to_pil(images, argument: dict = None):
        """
