...
class KarrasVeScheduler(SchedulerMixin, ConfigMixin):
    ...
    def add_noise_to_input(
        self, sample: Union[paddle.Tensor, np.ndarray], sigma: float
    ) -> Tuple[Union[paddle.Tensor, np.ndarray], float]:
        """
        ...
        eps = self.s_noise * self.randn_like(sample) #.to(sample.device)
    ...
    def step(
        ...
        Args:
            ...
            sample_hat (`paddle.Tensor` or `np.ndarray`): TODO
    ...
    def step_correct(
        ...
        Args:
            ...
            sigma_prev (`float`): TODO
            sample_hat (`paddle.Tensor` or `np.ndarray`): TODO
            sample_prev (`paddle.Tensor` or `np.ndarray`): TODO
            derivative (`paddle.Tensor` or `np.ndarray`): TODO
            return_dict (`bool`): option for returning tuple rather than SchedulerOutput class
