...
class ScoreSdeVeScheduler(SchedulerMixin, ConfigMixin):
    ...
    Args:
        ...
        tensor_format (`str`): "np" or "pd" for the expected format of samples passed to the Scheduler.
    """
    ...
    def set_sigmas(
        ...
        if tensor_format == "np":
            ...
            self.discrete_sigmas = paddle.exp(paddle.linspace(np.log(sigma_min), np.log(sigma_max), num_inference_steps))
    ...
    def get_adjacent_sigma(self, timesteps, t):
        ...
        if tensor_format == "np":
            ...
            return paddle.where(
                timesteps == 0,
                paddle.zeros_like(t), # .to(timesteps.device)
    ...
    def step_correct(
        ...
        **kwargs,
        ...
        step_size = step_size * paddle.ones([sample.shape[0]])#.to(sample.device)
