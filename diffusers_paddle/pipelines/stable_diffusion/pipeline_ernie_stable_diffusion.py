from paddlenlp.transformers import ErnieModel, ErnieViLPretrainedModel, register_base_model, ErnieViLTokenizer

class ErnieViLTextPretrainedModel(ErnieViLPretrainedModel):
    pass
@register_base_model
class ErnieViLTextModel(ErnieViLTextPretrainedModel):
    def __init__(self,
...
class ErnieStableDiffusionPipeline(DiffusionPipeline):
    r"""
    ...
    def __init__(
        self,
        vae: AutoencoderKL,
        text_encoder: ErnieViLTextModel,
